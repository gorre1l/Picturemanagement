    ...
    <ul id="categories" name="categories">
     ...
     try{
      Connection con=DatabaseC.getConnection();
         ...
         ResultSet rs=st.executeQuery("select * from  photos where eid='"+uid+"'");
         String pname;
...
String str=rs.getString(3).trim();
	  ...
	  <li class="category">
        ...
        <p></p>
        <p class="readmore"><a href='photo.jsp?pname=<%= str %>'>Read More &raquo;</a></p>
      </li>
...
<div id="Layer4">
  <form action="UploadFile.jsp" method="post" enctype="multipart/form-data" name="form1" class="style1" id="form1">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong> upload picture </strong><br/>

	Title  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
	<input type="text" name="photo_id" required="required"  />
	Description
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
